  ...
  return (
    <Html lang="pt-BR">
      <Head>
        ...
        <meta name="description" content="Encontre o café perfeito para qualquer hora do dia. Com o Coffee Delivery você recebe seu café onde estiver, a qualquer hora" />
